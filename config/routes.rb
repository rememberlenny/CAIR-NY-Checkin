...
Rails.application.routes.draw do
  get "preview/:number" => 'preview_message#show' if ENV['ALLOW_MESSAGE_PREVIEW'].present?
  post "preview/:number" => 'preview_message#submit' if ENV['ALLOW_MESSAGE_PREVIEW'].present?
